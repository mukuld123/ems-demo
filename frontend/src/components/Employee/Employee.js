    ...
    <div className="mx-auto col-10 col-md-8 col-lg-6">
      <div class="container-emp">
        ...
        <form className='form-emp' onSubmit={handleSubmit}>
          ...
          <div class="form-row">
            <div class="input-data">
              <input type="text" id='emp_fname' value={formInfo.emp_fname} name='emp_fname' onChange={handleChange} required />

              <div class="underline"></div>
              <label for="">First Name</label>
            </div>
            <div class="input-data">
              <input type="text" id='emp_lname' value={formInfo.emp_lname} name='emp_lname' onChange={handleChange} required />
          ...
          <div class="form-row">
            <div class="input-data">
              <select className='form-select form-select-lg mb-3' value={formInfo.emp_gender} name="emp_gender" id="emp_gender" onChange={handleChange} >
            ...
            <div class="input-data">
              <input type="date" id='emp_dob' value={formInfo.emp_dob} name='emp_dob' onChange={handleChange} />
          ...
          <div class="form-row">
            ...
            <div class="input-data">
              <select name="emp_manager" value={formInfo.emp_manager} class="form-select form-select-lg mb-3" id="emp_manager" onChange={handleChange} >
            ...
            <div class="input-data">
              <input type="tel" id='emp_contact' value={formInfo.emp_contact} name='emp_contact' onChange={handleChange} required />
          ...
          <div class="form-row">
            <div class="input-data">
              <input type="text" id='emp_city' value={formInfo.emp_city} name='emp_city' onChange={handleChange} required />

              <div class="underline"></div>
              <label for="">City</label>
            </div>
            <div class="input-data">
              <input type="text" id='acc_no' value={formInfo.acc_no} name='acc_no' onChange={handleChange} required />
          ...
          <div class="form-row">
            <div class="input-data">
              <input type="text" id='ifsc_code' value={formInfo.ifsc_code} name='ifsc_code' onChange={handleChange} required />
              <div class="underline"></div>
              <label for="">IFSC code</label>
            </div>

            <div class="input-data">
              <input type="text" id='bank_name' value={formInfo.bank_name} name='bank_name' onChange={handleChange} required />
              <div class="underline"></div>
          ...
          <div class="form-row">
            <div class="input-data">
              <select name="dept_id" value={formInfo.dept_id} class="form-select form-select-lg mb-3" id="dept_id" onChange={handleChange} >
            ...
            <div class="input-data">
              <select name="role_id" value={formInfo.role_id} class="form-select form-select-lg mb-3" id="role_id" onChange={handleChange} >
          ...
          <div class="form-row">
            <div class="input-data">
              <input type="text" id='contact_person_name' value={formInfo.contact_person_name} name='contact_person_name' onChange={handleChange} required />
              <div class="underline"></div>
              <label for="">Contact Person</label>
            </div>

            <div class="input-data">
              <input type="text" id='contact_person_relation' value={formInfo.contact_person_relation} name='contact_person_relation' onChange={handleChange} required />
              <div class="underline"></div>
              <label for="">Contact Person Relation</label>
            </div>
          </div>
